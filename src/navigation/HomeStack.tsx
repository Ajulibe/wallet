...
export default function HomeNavigationStack() {
  return (
    <HomeStack.Navigator
      ...
      <HomeStack.Screen name={ROUTES.SEND_MONEY_TO_WALLET_SCREEN} component={SendMoneyToWallet} />
      <HomeStack.Screen name={ROUTES.SEND_MONEY_TO_BANK_ACCOUNT_SCREEN} component={SendMoneyToBankAccount} />
    </HomeStack.Navigator>
  );
}
